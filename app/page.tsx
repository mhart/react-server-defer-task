      ...
      {Array.from({ length: 20 }).map((_x, i) => (
        <section>
          ...
          <p>
            ...
            climes. Inspirited by this wind of promise, my daydreams become more
            fervent and vivid. I try in vain to be persuaded that the pole is
          ...
          <p>
            ...
            me to heaven, for nothing contributes so much to tranquillise the
            ...
            discovery composed the whole of our good Uncle Thomas' library. My
            education was neglected, yet I was passionately fond of reading.
            These volumes were my study day and night, and my familiarity with
            them increased that regret which I had felt, as a child, on learning
            that my father's dying injunction had forbidden my uncle to allow me
            to embark in a seafaring life.
          </p>
          {Array.from({ length: 100 }).map((_x, i) => (
            <p>Paragraph {i + 4}</p>
          ))}
        </section>
      ))}
